...
void initialize() {
 ...
 dEdge = 0;
 dTummy = ((31) | (31)<<5 | (0)<<10);
 dEyeEdge = ((31) | (31)<<5 | (31)<<10);
 dEyeColor = ((0) | (0)<<5 | (31)<<10);

 drawDragon(dCol, dRow, dSize, dColor, dEdge, dTummy, dEyeEdge, dEyeColor);

 drawDragonFire(dCol, dRow, dSize, ((31) | (0)<<5 | (0)<<10), ((31) | (31)<<5 | (0)<<10), ((31) | (31)<<5 | (31)<<10));
 ...
 gaCol = 50;
 gaRow = 0;
 gameColor1 = ((0) | (31)<<5 | (0)<<10);
 gameColor2 = ((31) | (0)<<5 | (0)<<10);
 gameColor3 = ((0) | (31)<<5 | (0)<<10);
 gameColor4 = ((0) | (31)<<5 | (0)<<10);
 gameColor5 = ((31) | (0)<<5 | (0)<<10);
 gameColor6 = ((0) | (31)<<5 | (0)<<10);
 gameColor7 = ((31) | (0)<<5 | (0)<<10);
 gameColor8 = ((0) | (31)<<5 | (0)<<10);
...
void update() {
 ...
 if ((!(~(oldButtons)&((1<<4))) && (~buttons & ((1<<4)))) || (~((*(volatile unsigned short *)0x04000130)) & (1<<4))) {
  dCol += 1;
 }

 if ((!(~(oldButtons)&((1<<5))) && (~buttons & ((1<<5)))) || (~((*(volatile unsigned short *)0x04000130)) & (1<<5))) {
  dCol -= 1;
 }
 ...
 if (collision(dCol, dRow, 12, 20, gaCol, gaRow+15, 10, 5)) {
  if (gameColor1 == ((0) | (31)<<5 | (0)<<10) && (winCounter <= 5)) {
   gameColor1 = bgColor;
   winCounter++;
  }
 }
 ...
 if (collision(dCol, dRow, 12, 20, gaCol + gaSpacing*2, gaRow+15, 10, 5)) {
  if (gameColor3 == ((0) | (31)<<5 | (0)<<10) && (winCounter <= 5)) {
   gameColor3 = bgColor;
   winCounter++;
  }
 }
 ...
 if (collision(dCol, dRow, 12, 20, gaCol + gaSpacing*3, gaRow+15, 10, 5)) {
  if (gameColor4 == ((0) | (31)<<5 | (0)<<10) && (winCounter <= 5)) {
   gameColor4 = bgColor;
   winCounter++;
  }
 }
 ...
 if (collision(dCol, dRow, 12, 20, gaCol + gaSpacing*5, gaRow+15, 10, 5)) {
  if (gameColor6 == ((0) | (31)<<5 | (0)<<10) && (winCounter <= 5)) {
   gameColor6 = bgColor;
   winCounter++;
  }
 }
 ...
 if (collision(dCol, dRow, 12, 20, gaCol + gaSpacing*7, gaRow+15, 10, 5)) {
  if (gameColor8 == ((0) | (31)<<5 | (0)<<10) && (winCounter <= 5)) {
   gameColor8 = bgColor;
   winCounter++;
  }
 }
 ...
 if ((gameColor1 == ((0) | (31)<<5 | (31)<<10)) && (gameColor3 == ((0) | (31)<<5 | (31)<<10)) && (gameColor4 == ((0) | (31)<<5 | (31)<<10))
 && (gameColor6 == ((0) | (31)<<5 | (31)<<10)) && (gameColor8 == ((0) | (31)<<5 | (31)<<10)) && (winCounter == 5)) {
  bgColor = ((0) | (31)<<5 | (0)<<10);
  fillScreen(bgColor);
  winCounter++;
  gameColor1 = ((0) | (31)<<5 | (0)<<10);
  gameColor2 = ((0) | (31)<<5 | (0)<<10);
  gameColor3 = ((0) | (31)<<5 | (0)<<10);
  gameColor4 = ((0) | (31)<<5 | (0)<<10);
  gameColor5 = ((0) | (31)<<5 | (0)<<10);
  gameColor6 = ((0) | (31)<<5 | (0)<<10);
  gameColor7 = ((0) | (31)<<5 | (0)<<10);
  gameColor8 = ((0) | (31)<<5 | (0)<<10);
 }
